...
const Hero = () => {
  // Placeholder ambient background stands in for the hero video until one is added.
  // Play Reel then simply toggles it on/off — swap in a <video> here later with the same handler.
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div
        ...
        className="hero-ambient-bg absolute top-0 left-0 w-full h-full z-0"
      >
        <div data-paused={!isPlaying} className="hero-orb absolute top-[15%] left-[10%] w-72 h-72 bg-red-600/20 rounded-full blur-[100px]" />
        <div data-paused={!isPlaying} className="hero-orb absolute bottom-[10%] right-[15%] w-96 h-96 bg-red-500/10 rounded-full blur-[120px]" style={{ animationDelay: '2s' }} />
      </div>
