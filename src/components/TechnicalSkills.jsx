...
const SkillChip = ({ name }) => (
  <span className="px-3 py-1.5 text-xs md:text-sm font-bold text-white/80 bg-white/5 rounded-full border border-white/10 hover:bg-red-500/10 hover:border-red-500/30 hover:text-red-300 transition-all duration-300 cursor-default">
    {name}
  </span>
);
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div data-aos="fade-up" className="mb-16 text-center">
          ...
          <p className="text-white/50 text-base md:text-lg max-w-xl mx-auto leading-relaxed">
            A comprehensive overview of the languages, frameworks, and AI/ML tooling I build with.
          </p>
        </div>
